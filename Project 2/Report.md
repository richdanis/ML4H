...
The idea is to find $U, W$ such that the modeled probabilities are as close as possible to the real probabilities.
After applying some further steps, one can define a loss function for optimizing $U, W$ and some bias $b$.
